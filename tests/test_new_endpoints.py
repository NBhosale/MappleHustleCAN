...
class TestUploadEndpoints:
    ...
    def test_upload_item_images_too_many(self):
        ...
        files = [("files", (f"test{i}.jpg", io.BytesIO(b"fake image"), "image/jpeg")) for i in range(11)]
        data = {"item_id": "123e4567-e89b-12d3-a456-426614174000"}
    ...
    def test_upload_document_success(self):
        ...
        files = {"file": ("cert.pdf", io.BytesIO(b"fake pdf data"), "application/pdf")}
        data = {"document_type": "certification"}
        
        with patch("app.routers.uploads.save_file") as mock_save:
            mock_save.return_value = "documents/certification/test_cert_123.pdf"
            
            response = client.post("/uploads/documents", files=files, data=data)
...
class TestBulkOperations:
    ...
    def test_bulk_create_services(self):
        ...
        with patch("app.routers.bulk.get_current_user") as mock_user:
            mock_user.return_value = MagicMock(id="123e4567-e89b-12d3-a456-426614174000")
    ...
    def test_bulk_create_services_too_many(self):
        ...
        services_data = [{"type": "house_cleaning", "title": f"Service {i}"} for i in range(51)]
    ...
    def test_bulk_delete_services(self):
        ...
        service_ids = ["123e4567-e89b-12d3-a456-426614174000", "123e4567-e89b-12d3-a456-426614174001"]
    ...
    def test_bulk_create_availability(self):
        ...
        with patch("app.routers.bulk.get_current_user") as mock_user:
            ...
            response = client.post("/bulk/availability", json=availability_data)
