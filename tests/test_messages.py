...
def test_client_can_send_message(client):
    _, client_tokens = create_user(client, "client4@example.com", "password123", role="client")
    _, provider_tokens = create_user(client, "provider6@example.com", "password123", role="provider")
