...
class TestFilesRouter:
    ...
    def test_upload_file_invalid_type(self, client: TestClient, db_session: Session):
    ...
    def test_upload_file_too_large(self, client: TestClient, db_session: Session):
    ...
    def test_upload_file_missing_file(self, client: TestClient, db_session: Session):
    ...
    def test_upload_file_missing_data(self, client: TestClient, db_session: Session):
    ...
    def test_get_file_invalid_id(self, client: TestClient, db_session: Session):
    ...
    def test_list_files_with_filters(self, client: TestClient, db_session: Session):
    ...
    def test_list_files_pagination(self, client: TestClient, db_session: Session):
    ...
    def test_delete_file_not_found(self, client: TestClient, db_session: Session):
        """Test delete file with non-existent ID"""
        response = client.delete("/files/00000000-0000-0000-0000-000000000000")
        assert response.status_code == 404
    
    def test_update_file_metadata(self, client: TestClient, db_session: Session):
        ...
        # Update metadata
        update_data = {"description": "Updated description", "tags": ["updated", "test"]}
    ...
    def test_get_file_content_not_found(self, client: TestClient, db_session: Session):
        """Test get file content with non-existent ID"""
        response = client.get("/files/00000000-0000-0000-0000-000000000000/content")
        assert response.status_code == 404
    
    def test_upload_multiple_files(self, client: TestClient, db_session: Session):
        ...
        response = client.post("/files/upload-multiple", files=files, data=data)
        assert response.status_code == 201
        files_response = response.json()
        assert isinstance(files_response, list)
        assert len(files_response) == 3
    
    def test_get_file_statistics(self, client: TestClient, db_session: Session):
