...
class TestHealthRouter:
    ...
    def test_health_check_detailed(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_database(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_services(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_metrics(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_readiness(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_liveness(self, client: TestClient, db_session: Session):
        """Test liveness probe"""
    ...
    def test_health_check_version(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_environment(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_dependencies(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_performance(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_security(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_custom_headers(self, client: TestClient, db_session: Session):
    ...
    def test_health_check_error_handling(self, client: TestClient, db_session: Session):
