...
class TestAvailabilityValidation:
    ...
    def test_validate_availability_time_slot_too_long(self):
        ...
        assert "Availability slot cannot exceed 24 hours" in str(exc_info.value.detail)
    ...
    def test_validate_availability_time_slot_too_short(self):
        ...
        assert "Availability slot must be at least 15 minutes" in str(exc_info.value.detail)
...
class TestBookingValidation:
    ...
    def test_validate_booking_advance_notice_insufficient(self):
        ...
        assert "Bookings must be made at least 2 hours in advance" in str(exc_info.value.detail)
    ...
    def test_validate_booking_advance_notice_too_far(self):
        ...
        assert "Bookings cannot be made more than 6 months in advance" in str(exc_info.value.detail)
    ...
    def test_validate_booking_duration_too_short(self):
        ...
        assert "Booking must be at least 30 minutes" in str(exc_info.value.detail)
...
class TestGeographicValidation:
    ...
    def test_validate_postal_code_invalid(self):
        ...
        for code in invalid_codes:
            ...
            assert "Invalid Canadian postal code format" in str(exc_info.value.detail)
    ...
    def test_validate_geographic_constraints_different_province(self):
        ...
        assert "only available within the same province" in str(exc_info.value.detail)
