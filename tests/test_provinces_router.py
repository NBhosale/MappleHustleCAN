...
class TestProvincesRouter:
    ...
    def test_get_province_by_code(self, client: TestClient, db_session: Session):
    ...
    def test_get_province_invalid_code(self, client: TestClient, db_session: Session):
        """Test get province with invalid code"""
        response = client.get("/provinces/XX")
        assert response.status_code == 404
    
    def test_get_provinces_with_filters(self, client: TestClient, db_session: Session):
    ...
    def test_get_provinces_pagination(self, client: TestClient, db_session: Session):
    ...
    def test_get_provinces_search(self, client: TestClient, db_session: Session):
    ...
    def test_get_provinces_sorting(self, client: TestClient, db_session: Session):
    ...
    def test_get_provinces_invalid_sort(self, client: TestClient, db_session: Session):
