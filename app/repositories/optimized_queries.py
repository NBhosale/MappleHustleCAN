...
class OptimizedUserQueries:
    ...
    @staticmethod
    def get_user_with_notifications(
            db: Session,
...
class OptimizedServiceQueries:
    ...
    @staticmethod
    def get_services_with_provider(
            db: Session,
            skip: int = 0,
            limit: int = 10) -> List[Service]:
    ...
    @staticmethod
    def get_service_with_bookings(db: Session,
    ...
    @staticmethod
    def get_service_with_reviews(db: Session,
                                 service_id: str) -> Optional[Service]:
    ...
    @staticmethod
    def get_services_by_provider_with_stats(
            db: Session, provider_id: str) -> List[Service]:
...
class OptimizedBookingQueries:
    ...
    @staticmethod
    def get_bookings_with_relations(
            db: Session,
            skip: int = 0,
            limit: int = 10) -> List[Booking]:
    ...
    def get_user_bookings_with_relations(
            db: Session, user_id: str) -> List[Booking]:
    ...
    @staticmethod
    def get_provider_bookings_with_relations(
            db: Session, provider_id: str) -> List[Booking]:
...
class OptimizedOrderQueries:
    ...
    @staticmethod
    def get_order_with_full_details(
            db: Session,
...
class OptimizedPaymentQueries:
    ...
    @staticmethod
    def get_user_payments_with_order(
            db: Session,
            user_id: str) -> List[Payment]:
...
class OptimizedItemQueries:
    ...
    @staticmethod
    def get_provider_items_with_stats(
            db: Session, provider_id: str) -> List[Item]:
...
class OptimizedMessageQueries:
    ...
    @staticmethod
    def get_conversation_with_users(
            db: Session,
            user1_id: str,
            user2_id: str) -> List[Message]:
    ...
    @staticmethod
    def get_user_messages_with_relations(
            db: Session, user_id: str) -> List[Message]:
...
class OptimizedNotificationQueries:
    ...
    @staticmethod
    def get_user_notifications_with_relations(
            db: Session, user_id: str) -> List[Notification]:
        """Get user notifications with relations (eager loading)"""
        return db.query(Notification).options(
            joinedload(
                Notification.user)).filter(
            Notification.user_id == user_id).order_by(
...
class OptimizedReviewQueries:
    ...
    @staticmethod
    def get_reviews_with_relations(
            db: Session,
            skip: int = 0,
    ...
    @staticmethod
    def get_service_reviews_with_users(
            db: Session, service_id: str) -> List[Review]:
        """Get service reviews with users (eager loading)"""
        return db.query(Review).options(
            joinedload(
                Review.user)).filter(
            Review.service_id == service_id).order_by(
...
class OptimizedSubscriptionQueries:
    ...
    @staticmethod
    def get_user_subscriptions_with_relations(
            db: Session, user_id: str) -> List[Subscription]:
