...
def process_image_file(file_path: str, user_id: str, item_id: Optional[str]) -> Dict[str, Any]:
...
def process_document_file(file_path: str, user_id: str, item_id: Optional[str]) -> Dict[str, Any]:
...
def process_generic_file(file_path: str, user_id: str, item_id: Optional[str]) -> Dict[str, Any]:
...
def backup_user_files(
    ...
    try:
        ...
        try:
            ...
            logger.info(f"Backed up {len(backed_up_files)} files for user {user_id}")
