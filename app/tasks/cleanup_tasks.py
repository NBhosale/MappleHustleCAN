...
def cleanup_temp_files(self):
    ...
    try:
        ...
        logger.info(
            f"Cleaned up {total_deleted} temp files ({
                ...
                for file in os.listdir(log_dir):
                    if file.endswith('.log'):
                        ...
                        try:
                            ...
                            logger.warning(
                                f"Failed to delete log file {file_path}: {e}")

        logger.info(
            f"Cleaned up {total_deleted} log files ({
                total_size / 1024 / 1024:.2f} MB)")
        return {
            "status": "success",
            "deleted_files": total_deleted,
...
def backup_database(self):
    ...
    try:
        ...
        # This is a simplified version - in production, use proper database
        # backup tools
        import subprocess
...
def cleanup_old_backups(self):
    ...
    try:
        ...
        logger.info(
            f"Cleaned up {total_deleted} old backup files ({
                total_size / 1024 / 1024:.2f} MB)")
        return {
            "status": "success",
            "deleted_files": total_deleted,
...
def cleanup_cache(self):
    ...
    try:
        ...
        # Clean up expired keys (Redis does this automatically, but we can
        # force it)
